...
/** 05.用途詳細区分設定 */
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10101, '分譲マンション', '分譲マンション、分譲リゾートマンション');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10102, '賃貸マンション', '賃貸マンション、公営住宅、ＵＲ賃貸住宅、アパート');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10103, 'ワンルームマンション', 'ワンルームマンション、学⽣マンション、シェアハウス');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10104, '社宅・家族寮', '社宅、家族寮、公務員宿舎、教職員住宅、職員住宅');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10105, '独⾝寮', '独⾝寮、学⽣会館、学⽣交流館、学⽣寮、寄宿舎、⽣徒寮、選⼿寮、待機宿舎、隊舎');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10106, '⼾建住宅', '個⼈住宅、併⽤住宅');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10201, '⾃社ビル（⼀般事務所）', '⾃社ビル、庁舎、会館、警察署、公館、裁判所、消防署、放送局、スタジオ');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10202, '貸事務所', '貸事務所、貸ビル、テナントビル');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10203, '銀⾏・⾦融', '銀⾏、信⽤⾦庫、郵便局、農協');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10204, '電算センター', '電算センター、データセンター');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10205, '管理事務所', '管理事務所、電気室・電気棟、電源局舎、ボイラー室、墓苑管理棟、無線局舎、訓練塔、管制塔、観測所、機械室・機械棟、気象レーダー局舎、訓練棟、ビジターセンター、交番、派出所、消防団詰所');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10206, '研究施設', '研究所、研究センター');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10207, '研修施設', '研修施設');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10301, '都市型店舗', '商業ビル、百貨店');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10302, '⼤規模物販店', 'スーパー等の核テナントを中⼼としたショッピングセンター、アウトレットモール');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10303, '各種専⾨店', '各種専⾨店（家電量販店、家具店、⾐料品店、ドラッグストア、調剤薬局、写真スタジオ、ガソリンスタンド、携帯ショップ等）');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10304, 'スーパー・コンビニ', '⾷品スーパー専⾨店、コンビニエンスストア');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10305, 'ホームセンター', 'ホームセンター');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10306, 'ショールーム', '⾃動⾞ショールーム、住設機器ショールーム');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10307, '飲⾷店', '飲⾷店、飲⾷店ビル、カラオケ店');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10308, 'パチンコ店', 'パチンコ店');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10401, '市⺠会館・コミュニティセンター', '市⺠会館、コミュニティーセンター、イベントホール、⾳楽堂、会議場、カルチャーセンター、勤労福祉センター、区⺠館、劇場、公会堂、公⺠館、交流センター（交流館）、国際会議場、コンサートホール、コンベションセンター、市⺠センター、市⺠⽂化センター、集会所、集会場、⽣涯学習センター、多⽬的ホール');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10402, '博物館・美術館', '博物館、美術館、科学館、記念館、ギャラリー、情報館、資料館、⽔族館、展⽰場');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10403, '結婚式場', '結婚式場');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10404, '宗教建築', '位牌堂、神楽殿、客殿、教会、庫裡、座禅堂、参集殿、寺院、司祭館、社務所、修道院、書院、神社、納⾻堂、本堂、礼拝堂、礼拝所');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10405, '葬祭場', '葬祭場、葬儀場、斎場、セレモニーホール、⽕葬場');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10406, '図書館', '図書館');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10501, '保育園・幼稚園', '保育園、保育所、幼稚園、こども園');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10502, '校舎（⼩学校）', '⼩学校');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10503, '校舎（中学・⾼校）', '中学校、⾼校、中⾼⼀貫校');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10504, '校舎（⾼専・短⼤・⼤学）', '⾼等専⾨学校、短期⼤学、⼤学、⼤学院');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10505, '校舎（専⾨学校）', '専⾨学校、学習塾、⾃動⾞教習所、職業訓練校、職業訓練センター、予備校');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10601, '病院', '⼀般病院、総合病院、⼤学附属病院、介護⽀援系病院、リハビリテーション病院、療育センター');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10602, '医院・診療所', '医院、診療所、クリニック、動物病院');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10603, '検診センター', '検診センター、医師会センター、市⺠健康センター、保健所、保健センター、保健福祉センター');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10701, '⾼齢者向け住宅', 'サービス付⾼齢者向け住宅、介護付⾼齢者住宅');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10702, '⽼⼈ホーム', '⽼⼈ホーム、特別養護⽼⼈ホーム、有料⽼⼈ホーム、養護⽼⼈ホーム、ケアハウス、軽費⽼⼈ホーム、⾼齢者⽀援ハウス、⼩規模多機能介護施設、シルバーハウス、⽣活⽀援ハウス');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10703, 'グループホーム', 'グループホーム');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10704, 'デイサービス・ショートステイ', 'デイサービス、ショートステイ、障害者デイケア、通所介護施設、デイケアセンター');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10705, '⽼⼈保健施設', '介護⽼⼈保健施設');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10706, '複合福祉施設', '複合福祉施設、福祉センター、総合サービス、福祉会館');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10707, '児童福祉施設', '児童館、学童クラブ、放課後児童クラブ、児童センター、児童相談所、児童養護施設、特別⽀援学校、養護学校、乳児院');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10708, '⾼齢者・障害者⽀援施設', '救護施設、就労⽀援施設、授産施設、障害者⽀援センター、障害者リハビリ施設、地域包括⽀援センター、在宅介護⽀援センター、知的障碍者更⽣施設、リハビリテーション施設');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10801, 'シティホテル', 'シティホテル（宴会場を有するホテル）');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10802, 'ビジネスホテル', 'ビジネスホテル、カプセルホテル');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10803, 'リゾートホテル', 'リゾートホテル、レジャーホテル');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10804, '旅館', '旅館、ゲストハウス');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10805, '保養所', '保養所、合宿所、社員クラブ、研修所');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10901, '体育館', '体育館、屋内運動場、講堂、学校の講堂、ダンスホール、武道場、空⼿道場、射撃場、屋内グラウンド、屋内スケート場、屋内スポーツ練習場');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10902, 'クラブハウス', 'クラブハウス、ゴルフ場クラブハウス、更⾐棟、部室');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10903, '総合レジャー施設', '映画館、場外⾺・⾈・⾞券売り場、バッティングセンター、ボーリング場');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10904, 'フィットネスクラブ', 'フィットネスクラブ、スポーツジム、スポーツクラブ、トレーニングセンター');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10905, 'プール施設', 'プール');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10906, '公衆浴場', '公衆浴場、温泉施設、温浴施設、健康ランド、スーパー銭湯');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (10907, '屋外スタジアム', '屋外スタジアム、観覧席、競技場、競⾺場・競輪場スタンド、ボートレース場スタンド、野外ステージ、野球場、サッカー場');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (11001, '流通センター', '流通センター、集配施設、配送センター、物流センター、郵便処理施設、ロジスティクスセンター');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (11002, '⼀般倉庫', '⼀般倉庫、収蔵庫、⽂書保管倉庫');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (11003, '冷凍倉庫・冷蔵倉庫', '冷凍倉庫、冷蔵倉庫、低温倉庫、定温倉庫');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (11004, '⽴体倉庫', '⽴体倉庫、⾃動倉庫');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (11005, '特殊倉庫', '特殊倉庫、危険物倉庫、防災⽤備蓄倉庫、道路啓開基地');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (11006, '作業所', '作業所・作業場、市場、荷捌き場、陸揚げ場');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (11007, '⾞庫・格納庫', '⾞庫、格納庫、バス・モノレール基地');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (11101, '⼯場（精密機械電気等）', '精密機械電気⼯場（精密機械⼯業、電⼦部品⼯場、半導体⼯場、IC⼯場など）');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (11102, '⼯場（⾃動⾞整備）', '⾃動⾞整備⼯場、⾞検場');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (11103, '⼯場（⾷品）', '⾷品⼯場(パン⼯場、野菜加⼯⼯場、ビール⼯場、飲料製造⼯場、惣菜製造⼯場、弁当⼯場など）、給⾷センター');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (11104, '⼯場（医薬品）', '医薬品⼯場、医療品⼯場');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (11105, '⼯場（機械電気・⾦属・その他）', '機械製作⼯場、機械組⽴⼯場、印刷⼯場、⽊材加⼯⼯場、プレス⼯場、溶接⼯場、⾦属加⼯⼯場、鋳物⼯場、塗装⼯場など');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (11106, '⼯場（化学）', '洗濯⼯場、化成品⼯場、製紙⼯場、化粧品⼯場、農薬⼯場、化学製品製造⼯場、塗料製造⼯場、ガラス⼯場、繊維⼯場、合成樹脂製品製造⼯場など');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (11107, '清掃・処理⼯場', '下⽔処理施設、浄化センター、排⽔処理施設、揚⽔機場');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (11108, '農林⽔産関連施設', 'ライスセンター、精⽶⼯場、畜舎、温室、脱穀所、堆肥舎、果実選果場、教育施設農林⽔産関係実習施設');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (11201, '駐⾞場（屋外を除く）', '駐⾞場、駐輪場');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (11202, '駅舎', '駅舎');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (11203, '公衆トイレ', '公衆トイレ');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (11204, '変電所', '変電所');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (20101, '外構', '外構');
INSERT INTO purpose_detail (pd_id, pd_type_name, pd_included_type) VALUES (20201, 'とりこわし', 'とりこわし工事単独発注');
